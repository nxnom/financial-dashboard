import { XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, TooltipProps, AreaChart, Area } from 'recharts'
...
const RevenueChart = ({
    ...
    return (
        <div className="bg-white dark:bg-[#56459E] rounded-2xl p-4">
                    ...
                    <AreaChart data={data} margin={{ top: 5, right: 0, bottom: 5, left: 0 }}>
                        <defs>
                            <linearGradient id="revenue2021" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor={isDarkMode ? "#505FAD" : "#E9F3FE"} stopOpacity={0.9} />
                                <stop offset="95%" stopColor={isDarkMode ? "#935AD6" : "#E9DDF9"} stopOpacity={0} />
                            </linearGradient>
                            <linearGradient id="revenue2020" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor={isDarkMode ? "#505FAD" : "#F8E1F2"} stopOpacity={0.8} />
                                <stop offset="95%" stopColor={isDarkMode ? "#935AD6" : "#ECDAFE"} stopOpacity={0.2} />
                            </linearGradient>
                        </defs>
                        ...
                        <YAxis
                            ...
                            axisLine={false}
                            width={35}
                            domain={[0, (dataMax: number) => Math.ceil(dataMax / 5000) * 5000]}
