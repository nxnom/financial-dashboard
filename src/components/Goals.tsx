...
const Goals = ({ goals }: GoalsProps) => {
  ...
  return (
    <div className="flex flex-col bg-white dark:bg-[#56459E] rounded-2xl p-3 sm:p-4 overflow-hidden h-auto sm:min-h-[240px] shadow-lg shadow-gray-300/50 dark:shadow-black/10">
