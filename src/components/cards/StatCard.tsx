...
const StatCard = ({ title, amount, percentageChange, period = 'this month', chartData }: StatCardProps) => {
    ...
    <div className="relative overflow-hidden bg-white dark:bg-[#56459E] rounded-2xl p-4 border border-gray-100 dark:border-0">
      ...
      <div className="flex items-center justify-between">
        <div className={classNames(
          ...
          <span className='text-[10px]'>{isPositive ? '+' : ''}{percentageChange}%</span>
        </div>
            ...
            <AreaChart data={chartData?.map((value) => ({value }))}>
              <defs>
                <linearGradient id="colorValue" x1="0" y1="0" x2="1" y2="0">
                  <stop offset="5%" stopColor={isDarkMode ? "#505FAD" : "#E9F3FE"} stopOpacity={0.1}/>
                  <stop offset="95%" stopColor={isDarkMode ? "#935AD6" : "#E9DDF9"} stopOpacity={1}/>
                </linearGradient>
              </defs>
              <Area
                type="monotone"
